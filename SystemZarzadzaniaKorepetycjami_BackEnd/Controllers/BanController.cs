...
public class BanController : ControllerBase
{
	...
	public async Task<IActionResult> CreateBanAsync(BanDetailsDTO ban)
	{
		...
		switch(banStatus) 
		{
			case BanStatus.OK : return Ok();
				break;
			case BanStatus.INVALID_BAN : return StatusCode(StatusCodes.Status500InternalServerError, "Invalid Ban");
				break;
			case BanStatus.SERVER_ERROR : return StatusCode(StatusCodes.Status500InternalServerError, "Server error");
				break;
			case BanStatus.INVALID_BANED_ID : return StatusCode(StatusCodes.Status500InternalServerError, "Invalid Bened Id");
				break;
			default:
	...
	public async Task<IActionResult> UpdateBanAsync(int idBan, BanDetailsDTO ban)
	{
		...
		switch(banStatus) 
		{
			...
			case BanStatus.SERVER_ERROR : return StatusCode(StatusCodes.Status500InternalServerError, "Server error");
				break;
			case BanStatus.INVALID_BANED_ID : return StatusCode(StatusCodes.Status500InternalServerError, "Invalid Baned Id");
				break;
			default:
				return StatusCode(StatusCodes.Status500InternalServerError, "Server error");
		}
