...
public class OpinionService : IOpinionService
{
	...
	public OpinionService(IOpinionRepository opinionRepository, IStudentRepository studentRepository, ITeacherRepository teacherRepository, IPersonRepository personRepository, ILessonRepository lessonRepository)
	{
	...
	public async Task<OpinionStatus> CreateOpinionAsync(OpinionCreateDTO opinionCreateDTO)
	{
		try 
		{
			...
			{
				return OpinionStatus.INVALID_STUDENT_OR_TEACHER;
			}
